This WebUI API documentation applies to qBittorrent v4.1+. For other WebUI API versions, visit [the home page](https://github.com/qbittorrent/qBittorrent/wiki#WebUI-API).
