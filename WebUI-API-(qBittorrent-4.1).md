This WebUI API documentation applies to qBittorrent v4.1+. For other API versions, visit [API Documentation](https://github.com/qbittorrent/qBittorrent/wiki#WebUI-API).
