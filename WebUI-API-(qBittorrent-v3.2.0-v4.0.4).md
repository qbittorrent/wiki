This WebUI API documentation applies to qBittorrent v3.2.0-v4.0.4. For other API versions, visit [the home page](https://github.com/qbittorrent/qBittorrent/wiki#WebUI-API).
