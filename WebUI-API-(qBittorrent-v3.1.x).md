...
`anonymous_mode` - if true [anonymous mode](Anonymous-Mode) will be enabled; this option is only available in qBittorrent built against libtorrent version 0.16.X and higher \
